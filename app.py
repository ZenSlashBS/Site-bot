...
import telebot  # already present
import os
import requests
...
<head>
    ...
    <style>
        body {
            ...
            margin: 0;
            padding: 0;
            /* pin the gradient so it doesn’t repeat as you scroll */
...
<body>
        ...
        <div id="modal-{{ prod.id }}" class="modal">
          <div class="modal-content">
            ...
            <img src="{{ prod.image_path }}"
                 style="width:100%;{% if cat=='Creators' %}border-radius:50%;max-width:200px;height:200px;display:block;margin:0 auto;{% endif %}">
            <p>{{ prod.bio }}</p>
            {% if cat!='Creators' %}
              <div class="price">${{ '%.2f' % prod.price }}</div>
              <a class="purchase" href="https://t.me/philoxnex?text=Hi%20Im%20interested%20to%20buy%20{{ prod.title|urlencode }}">Purchase</a>
    ...
    <script>
      ...
      // Sparkles now start from the tube-light element
